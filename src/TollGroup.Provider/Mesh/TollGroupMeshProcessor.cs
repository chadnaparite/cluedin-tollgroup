...
{
    public class TollGroup_Command_MeshProcessor : BaseMeshProcessor
    {
        public TollGroup_Command_MeshProcessor(ApplicationContext appContext)
            : base(appContext)
        {
        }

        public override Guid GetProviderId() =>
          TollGroupConstants.ProviderId;
