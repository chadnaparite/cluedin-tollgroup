...
{
    public class DataIngestion : IClassFixture<TollGroupTestFixture>
    {
        private readonly TollGroupTestFixture fixture;
        private readonly ITestOutputHelper output;

        public DataIngestion(TollGroupTestFixture fixture, ITestOutputHelper output)
        {
